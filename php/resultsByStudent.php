...
session_start();
 ...
 if (isset($_GET)) {
 	$test_id=$_GET['id'];
 	$q="select * from student where id in (select student_id from attempt where test_id=$test_id group by student_id)";
	$sdata=$con->query($q);
 }
...
<script src="http://localhost/project008/javascript/resultsByStudent.js">
</script>
</body>
</html>